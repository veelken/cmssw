...
updateAntiElectronDiscrMVA = True
...
if updateAntiElectronDiscrMVA:
    process.load('RecoTauTag/TauAnalysisTools/writeAntiElectronDiscrMVA_cfi')
...
if updateAntiMuonDiscrMVA:
    process.load('RecoTauTag/TauAnalysisTools/writeAntiMuonDiscrMVA_cfi')
...
if updateTauIdDiscrMVA:
    process.load('RecoTauTag/TauAnalysisTools/writeTauIdDiscrMVA_cfi')
