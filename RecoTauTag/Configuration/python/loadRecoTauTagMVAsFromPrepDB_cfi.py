...
loadRecoTauTagMVAsFromPrepDB = cms.ESSource("PoolDBESSource",
    ...
    ##connect = cms.string('sqlite_file:/data1/veelken/tmp/boostedTaus_for_CMSSW_7_0_x/CMSSW_7_0_0_pre12/src/RecoTauTag/Configuration/data/RecoTauTag_MVAs_2014Jan24.db')
)
